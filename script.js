...
const createList = (item) => {
    ...
    <div>${item}</div>
				<div>
					<svg class="svgBin" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 512 512">
					<g>
					<g fill="#231F20">
    ...
    const svg = newList.querySelector(".svgBin")
    svg.addEventListener("click", () => {
        const parentNode = svg.parentNode;
        const index = listArray.indexOf(item);
